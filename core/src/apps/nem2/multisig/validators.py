from trezor.messages.NEM2SignTx import NEM2MultisigModificationTransaction, NEM2SignTx
from trezor.wire import ProcessError


def _validate_multisig_modification(
    multisig_modification: NEM2MultisigModificationTransaction, version: int
):
