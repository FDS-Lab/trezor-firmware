...
def serialize_account_restriction(
    ...
    write_uint8(
        tx, len(account_restriction.restriction_additions)
    )  # account restriction additions count
    write_uint8(
        tx, len(account_restriction.restriction_deletions)
    )  # account restriction deletions count
    ...
    combined = (
        account_restriction.restriction_additions
        + account_restriction.restriction_deletions
    )
